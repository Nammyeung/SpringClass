...
<script type = "text/javascript">
	...
	};// 익명의 함수를 선언해서 변수에 넣어주겠다.(javascript 문법 => 함수 포인터를 넣을 수 있음.)

	xmlhttp.open("post", "./confirmId.do", true);
	xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");	
	xmlhttp.send("id=" + inputValue);
	
	// xmlhttp.open("get", "./confirmId.do?", true);
	...
	<div class = "row">
		...
		<div class = col>
			...
			<div class = "row mt-5">
				...
				<div class = "col">
					<input id = "id" placeholder = "이메일을 입력해주세요" name = "member_id" type = "text" class = "form-control"><input type="button" value="아이디확인" onclick="confirmID_jQuery()"><br>
				</div>							
			</div>
			<div class = "row">
				<div class = "col-4">
